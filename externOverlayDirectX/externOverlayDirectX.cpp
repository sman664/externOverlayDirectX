...
LPCSTR targetTitle = "AssaultCube";                 //target window's name goes here
int width, height;
                     ...
                     _In_ int       nCmdShow)
{
    ...
    DWORD procId = GetProcId("ac_client.exe");                      //name of process file or whatever client its called goes here
    ...
    paint = Paint(hProcess, overlayHWND, targetHWND, width, height);
